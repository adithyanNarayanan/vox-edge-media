                ...
                <div className="relative z-20 mt-auto">
                    <blockquote className="space-y-2">
                        <p className="text-xl font-light italic text-zinc-200">
                            &ldquo;This studio has transformed the way we produce content. The workflow is seamless and the quality is unmatched.&rdquo;
                        </p>
                        <footer className="text-sm font-semibold text-indigo-400">Sofia Davis</footer>
                    </blockquote>
                </div>
            </div>
            <div className="p-4 lg:p-8 h-full flex items-center justify-center bg-black">
                ...
                <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[500px] relative z-10">
                    ...
                    <p className="px-8 text-center text-sm text-zinc-500">
                        ...
                        <a href="/terms" className="underline underline-offset-4 hover:text-indigo-400 transition-colors">
                            Terms of Service
                        </a>{" "}
                        and{" "}
                        <a href="/privacy" className="underline underline-offset-4 hover:text-indigo-400 transition-colors">
                            Privacy Policy
                        </a>
                        .
                    </p>
